...
{
    console.log("main hooon");
        var urlService_ = '';

    var blue = '#337ab7',
        green = '#3db0a2', //'#7be2d5',
        yellow = '#cf7b04', //'#f0ad4e',
        blueText = '#61a5ee', //#4ab1eb',
        purple = '#9467bd',
        indigo=   '#ddaf23', //'#be8aec',
     pink = '#f05fa2' ; //#fbc2f1';
    ...
    var rectNode = { width : 120, height : 65, textMargin : 5 },
    ...
    function update(source)
    {
        ...
        nodeEnter.append('foreignObject')
            ...
            if(d.Spouse !== ""){
                ...
                var sDOD = "";
                if(d.SpouseDOD !== "") {
                    sDOD = '<b>DOD: </b>' + d.SpouseDOD + '<br>';
                }
                spouse =  '<b>Spouse\'s Name: </b>' + d.Spouse + '<br>'
                    + '<b>DOB: </b>' + d.SpouseDOB + '<br>' + sDOD ;

            }
                var nodedetails = '<div style="width: '
                    + (rectNode.width - rectNode.textMargin * 2) + 'px; height: '
                    + (rectNode.height - rectNode.textMargin * 2) + 'px;" class="node-text wordwrap">'
                    + '<b>' + d.MemberName + '</b><br>'
                    + '<b>DOB: </b>' + d.MemberDOB + '<br>'
                    + mDOD + '<br>'
                    + spouse;
